...
const listCrawlsQuery = db
  .select({
    ...
    pagesCrawled: crawl.pagesCrawled,
    pagesDiscovered: crawl.pagesDiscovered,
    perfDomContentLoaded: crawl.perfDomContentLoaded,
    perfFcp: crawl.perfFcp,
    perfLcp: crawl.perfLcp,
    perfPageLoadTime: crawl.perfPageLoadTime,
    perfPageSizeKb: crawl.perfPageSizeKb,
    perfRequestCount: crawl.perfRequestCount,
    perfResourceBreakdown: crawl.perfResourceBreakdown,
    perfTtfb: crawl.perfTtfb,
