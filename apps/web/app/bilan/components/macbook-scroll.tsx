...
export const MacbookScroll = ({
  ...
  const scaleX = useTransform(scrollYProgress, [0, 0.3], [1.2, 2.1]);
  const scaleY = useTransform(scrollYProgress, [0, 0.3], [0.6, 2]);
  const translate = useTransform(scrollYProgress, [0, 0.8, 1], [0, 1000, 0]);
