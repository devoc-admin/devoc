...
export const MacbookScroll = ({
  ...
  const scaleX = useTransform(scrollYProgress, [0, 0.3], [1.2, 2.4]);
  const scaleY = useTransform(scrollYProgress, [0, 0.3], [0.6, 2.3]);
  const translate = useTransform(scrollYProgress, [0, 0.8, 1], [0, 1300, 0]);
