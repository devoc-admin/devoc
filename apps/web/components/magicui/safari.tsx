...
export function Safari({
  ...
  const hasMedia = hasVideo || !!imageSrc || !!image

  return (
    <div
      className={cn("relative inline-block w-full align-middle leading-none",
        className
      )}
      style={{
    ...
    >
      ...
      {!hasVideo && !invisibleMode && (imageSrc || image) && (
        <div
          className="absolute z-0 overflow-hidden"
          style={{
            left: `${LEFT_PCT}%`,
      ...
      {invisibleMode &&
        <div className="rounded-md bg-slate-900/30 border-t border-r backdrop-sm border-primary w-full h-full"/>
      }
