export const OPEN_CARCA_WINNER_URL =
...
export const CAL_COMMUNES_LINK = "https://cal.com/dev-oc/bilan-communes";

export const MAIL_DEVOC = "contact@dev-oc.fr";
export const TEL_THIBAUT = "+33620239838";
export const TEL_THIBAUT_FORMATTED = "06 20 23 98 38";
export const TEL_CLEMENT = "+33658889701";
// export const OPEN_CARCA_WINNER_URL =
//   "https://www.carcassonne-agglo.fr/actualite/avec-clement-dubos-et-thibaut-izard-linformatique-sur-mesure/";
