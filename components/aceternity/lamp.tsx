  ...
  return (
    ...
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        <motion.div
          className="absolute inset-auto right-1/2 h-56 w-[25rem] max-w-[70vw] overflow-visible bg-gradient-conic from--primary via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        ...
        <motion.div
          className="absolute inset-auto left-1/2 h-56 w-[25rem] max-w-[70vw] bg-gradient-conic from-transparent via-transparent to-primary/20 text-white [--conic-position:from_290deg_at_center_top]"
          initial={{ opacity: 0.5, width: "15rem" }}
          style={{
            backgroundImage:
              "conic-gradient(var(--conic-position), var(--tw-gradient-stops))",
        ...
        <div className="-translate-y-1/2 absolute inset-auto z-50 h-36 w-[28rem] max-w-[80vw] rounded-full bg-primary opacity-50 blur-3xl" />
        <motion.div
        ...
        {/* ▬ Bar */}
        <motion.div
          className="-translate-y-[7rem] absolute inset-auto z-50 h-0.5 w-[25rem] max-w-[70vw] bg-primary"
