    ...
    <div className="h-screen w-full grid place-items-center">
      <div className="flex flex-col items-center gap-2">
        ...
        <Subtitle>
          ...
          votre entreprise vers le succès digital. Expertise technique, design
        ...
        >
          <Button className="rounded-full hover:bg-purple-600/90 hover:cursor-pointer hover:scale-101 bg-gradient-to-r from-purple-600 to-purple-400 px-8 py-5.5 text-lg font-bold">
